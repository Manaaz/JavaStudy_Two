...
public class MyServer {
    ...
    public synchronized void broadcastPrivateMessage(String message, ClientHandler sender, String clientRecipientName) throws IOException {

        for (ClientHandler client : clients) {
            if (client == sender || client.getUsername().equals(clientRecipientName)) {
                client.sendMessage(sender.getUsername(), message);
            }
        }
    }
